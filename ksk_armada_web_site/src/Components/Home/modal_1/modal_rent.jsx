...
const modal_rent = () => {
    return(
        ...
        <p>
            ...
            &mdash;&nbsp;сено вволю (по&nbsp;примерным подсчетам выходит около 20&nbsp;кг на&nbsp;голову), в&nbsp;денники раздается 4&nbsp;раза в&nbsp;день, в&nbsp;левадах лежит постоянно.
            &mdash;&nbsp;концентраты: овес/овес/каша. Овес плющеный, каша&nbsp;&mdash; плющеный овес + отруби. 
            &mdash;&nbsp;Добавление подкормок, замачивание втм и&nbsp;тому подобное&nbsp;&mdash; входит в&nbsp;стоимость
            &mdash;&nbsp;выгул от&nbsp;3-4x&nbsp;часов. По&nbsp;возможности стараемся отправить гулять на&nbsp;максимально длительное время.
            &mdash;&nbsp;для работы: крытая бочка 18&nbsp;м, манеж 18&times;50, конкурный и&nbsp;выездковый плацы, поля., комплект препятствий. 
